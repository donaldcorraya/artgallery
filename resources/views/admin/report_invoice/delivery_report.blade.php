...
@section('title', 'Delivery Report | Art Gallery')
@section('content')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                    <form action="{{ route('delivery.invioce') }}" method="post">
                        @csrf
                        <div class="row g-3">
                            <div class="col pb-3">
            ...
            <div class="col-md-12">
                <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                    ...
                    <div class="text-right mt-2">
                        ...
                        <a href="{{ route('export-delivery-report') }}" class="btn btn-info">Export to PDF</a>
                    </div>
                </div>
            </div>
            @endif
