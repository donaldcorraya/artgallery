...
@section('title', 'Top Banner Edit | Art Gallery')
@section('content')
...
<main id="main" class="main">
    ...
    <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <form method="post" action="{{ route('top_banner.update', $indexData->id) }}" enctype="multipart/form-data" class="row g-3 p-3">
            @csrf
            @method('PUT')
    
            <div class="col-md-6 pb-3">
                <label for="top_banner_title" class="form-label">Banner Title<span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="top_banner_title" name="top_banner_title" value="{{$indexData->top_banner_title}}" required>
            ...
            <div class="col-md-6 pb-3">
                ...
                <input type="text" class="form-control" id="top_banner_tagline" name="top_banner_tagline" value="{{$indexData->top_banner_tagline}}"required>
            ...
            <div class="d-flex">
                <div class="col-md-4">
                    ...
                    <input type="file" class="form-control" id="top_banner_img" name="top_banner_img" value="{{$indexData->top_banner_img}}">
